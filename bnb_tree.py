...
class BnB_Tree:
    ...
    def solve(self):
        ...
        # SHOULD WE PERFORM A COST REDUCTION LOWER BOUNDING ON ROOT NODE???
        ...
        # also, check if MAP relaxation was solved without any possible integer
        # overflow issues
        ...
        while not self.unpruned_nodes.empty():
            ...
            for node in children_nodes:
                ...
                # except TimeoutError:
                #     print("Google AP Solver took more than 10 seconds to solve \
                #           MAP for subproblem")
                ...
                #           and of course this solution is the best for this subproblem,
    ...
    def branch(self, node):
        ...
        # and branche the subproblem based on the subtourof its MAP optimal solution
        ...
        for i in range(num_children_nodes):
            ...
            # subproblem j= = j=1,...len(minimal_subtour_non_included_edges)
            # for child subproblem j,
            # exclude edge j of the minimal_subtour non included edges
            # and the current subproblem excluded edges, and
            # include edges 1...j-1 of the minimal subtour non included edges
        ...
        # return children nodes in the order of most number of new included edge
        # restrictions
    ...
    def minimal_subtour_edges(self, node_included_edges, node_MAP_sol):
        # for each subtour in MAP sol find how many non included edges it has
        # return edges of subtour with minimum number of edges not in in nodes included
        # edges
        # ideally order the edges according to carapento criteria, but for now we will
        # just return them in order of the tour as per simplified L version
        ...
        # iterated through all the subtours and find the subtour with the minimum numbe
    ...
    def prune_queue(self):
        # remove all subproblems from queue whose lower bound is no better than
