...
from random_CGLSP_instance_generator import get_random_CGLSP_instances
from MAP_brute_force_solver import *
...
for i, cost_matrix in enumerate(cost_matrices):
    ...
    print(f"Comparing solutions from Google OR Solver and Brute Force solver for test instance {i+1} / {num_test_instances} \n")
    ...
    print(f"Checking if Google OR solution and Brute Force solution are the same for test instance {i+1} / {num_test_instances} : \n")
    ...
    if failed_assertions > 0:
        ...
        print(f"Google OR solution and Brute Force solution ARE THE SAMME for test instance {i+1} / {num_test_instances} \n")
...
if failed_solves == 0:
    ...
    print(f"Unfortunately the brute force solver is giving the incorrect answer on {failed_solves} / {num_test_instances} instances\n")
